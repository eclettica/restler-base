...
function File(path, filename, fileSize, encoding, contentType, electronFs) {
  this.path = path;
  this.filename = filename || this._basename(path);
  this.fileSize = fileSize;
  this.encoding = encoding || "binary";
  this.contentType = contentType || 'application/octet-stream';
  if(electronFs != undefined && electronFs != null) {
  	fs = electronFs;
  }
}
...
var exportMethods = {
  file: function(path, filename, fileSize, encoding, contentType, electronFs) { 
    return new File(path, filename, fileSize, encoding, contentType, electronFs)
  },
